...
[![الإصدار](https://img.shields.io/badge/version-1.18.0-0B6B4F?style=for-the-badge)](https://github.com/ahmadmdm/hr-saudi-arabia-erpnext/releases/tag/v1.18.0)
![ERPNext](https://img.shields.io/badge/ERPNext-v15-1D3557?style=for-the-badge)
![Python](https://img.shields.io/badge/Python-3.10+-C89B3C?style=for-the-badge)
[![الفحوصات](https://img.shields.io/github/actions/workflow/status/ahmadmdm/hr-saudi-arabia-erpnext/quality.yml?branch=version-15&label=quality&style=for-the-badge)](https://github.com/ahmadmdm/hr-saudi-arabia-erpnext/actions/workflows/quality.yml)
...
هذه الصفحة تخص فرع **ERPNext v15**. لتثبيت النسخة المتوافقة:

الحزمة المختبرة: Saudi HR `1.18.0` — الإصدار `v1.18.0`.
...
تستخدم ERPNext v16؟ انتقل إلى **[فرع version-16](https://github.com/ahmadmdm/hr-saudi-arabia-erpnext/tree/version-16)** أو اختر v16 داخل **[التوتريال التفاعلي](https://ahmadmdm.github.io/hr-saudi-arabia-erpnext/#install)**.
