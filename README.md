...
[![Version](https://img.shields.io/badge/version-1.19.3-49D5A2?style=flat-square&labelColor=06161C)](https://github.com/ahmadmdm/hr-saudi-arabia-erpnext/releases/tag/v1.19.3-v16)
...
هذه الحزمة مخصصة لـ **ERPNext v16**. الحزمة المختبرة: Saudi HR `1.19.3` — الإصدار `v1.19.3-v16`.
