...
FEATURES = [
	...
	{"id": "shift-type", "category": "time", "title": "Shift Type", "title_ar": "أنواع الورديات", "summary": "Define shift schedules used by attendance and payroll controls.", "summary_ar": "تعريف جداول الورديات المستخدمة في الحضور والرواتب.", "target_type": "DocType", "target": "Shift Type"},
	{"id": "shift-assignment", "category": "time", "title": "Shift Assignment", "title_ar": "تعيين الورديات", "summary": "Assign employees to shift schedules for attendance validation.", "summary_ar": "تعيين الموظفين على الورديات للتحقق من الحضور.", "target_type": "DocType", "target": "Shift Assignment"},
	{"id": "shift-assignment-tool", "category": "time", "title": "Shift Assignment Tool", "title_ar": "أداة تعيين الورديات", "summary": "Bulk assign shifts and simplify workforce scheduling.", "summary_ar": "تعيين الورديات جماعياً وتبسيط جدولة القوى العاملة.", "target_type": "DocType", "target": "Shift Assignment Tool"},
